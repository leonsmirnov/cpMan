#!/bin/bash
# Launch cpMan with App Review demo content pre-loaded (text clips + sample images).
#
...
echo "   Press ⌃⌥V — you should see sample clips (e.g. \"Team standup notes\") plus two image clips."
echo ""
